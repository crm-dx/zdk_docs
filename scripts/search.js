(function() {
  ...
  input.addEventListener('keyup', () => {
    ...
    targets.forEach(target => {
      if (!target.innerText.toLowerCase().includes(input.value.toLowerCase()) && (target.getAttribute('data-methods') == null || !target.getAttribute('data-methods').toLowerCase().includes(input.value.toLowerCase()))) {
